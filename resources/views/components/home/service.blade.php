<section class="  h-72 py-16 ">
    ...
    <section class=" max-w-7xl mx-auto px-12 py-24 hidden sm:block">
                    ...
                    <div class="flex flex-col justify-between gap-6">
                        ...
                        <div class="">
                            ...
                            <p class="text-l font-medium opacity-60 mt-4">
                                ...
                                توافقها مع جميع الأجهزة وسهولة التصفح. سواء كنت بحاجة إلى موقع تعريفي، مدونة، أو منصة
                                إلكترونية، فنحن نقدم لك الحلول المثالية.
                            </p>
                        </div>
